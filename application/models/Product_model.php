...
class Product_model extends CI_Model{
    ...
    function __construct() {
        ...
        $this->custTable = 'shipping';
        $this->ordTable = 'orders';
        $this->ordItemsTable = 'order_product';
    }
    ...
    public function getOrder($id){
        ...
        $this->db->join($this->custTable.' as c', 'c.id = o.cust_id', 'left');
        $this->db->where('o.order_id', $id);
        $query = $this->db->get();
        $result = $query->row_array();
        
        // Get order items
        $this->db->select('i.*, p.product_img, p.product_name, p.product_price');
