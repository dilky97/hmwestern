				...
				<div class="row">
					<div class="col-lg-6 col-md-6">
						<div class="widget personal-info">
							...
							<?php echo form_open('welcome/save_user',['class'=>'form-horizontal']);?>
								<!-- First Name -->
                    ...
                    <div class="col-lg-6 col-md-6">
						...
						<div class="widget change-shipping-info">
							...
							<div class="form-group">
										...
										<?php echo form_input(['name'=>'address_line1','class'=>'form-control']);?>
										<!-- <input type="text" class="form-control" id="address_line1" name="address_line1"> -->
									</div>
									<div class="form-group">
										<label for="address_line2">Address Line 2</label>
										<?php echo form_input(['name'=>'address_line2','class'=>'form-control']);?>
									...
									<div class="form-group">
										...
										<?php echo form_input(['name'=>'postal_code','class'=>'form-control']);?>
										<!-- <input type="text" class="form-control" id="postal_code" name="postal_code"> -->
									</div>
									<div class="form-group">
										<label for="telephone">Contact No</label>
										<?php echo form_input(['name'=>'telephone','class'=>'form-control']);?>
										<!-- <input type="text" class="form-control" id="telephone" name="telephone"> -->
									</div>
								<!-- Submit Button -->
								<?php echo form_submit(['name'=>'save_user', 'value'=>'Save Changes','class'=>'btn btn-transparent']);?>
