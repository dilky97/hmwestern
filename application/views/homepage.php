		...
		<div class="row">
			<div class="col-md-12">
				...
				<div class="content-block">
					<h1>H & M Western (Pvt) Ltd.</h1>
					<p>Fresh seafood everyday <br>in local communities around the world</p>
...
<div class="product-item bg-light">
	<div class="card">
		<div class="thumb-content">
			...
			<a href="single.html">
				<img class="card-img-top img-fluid" src="<?php echo base_url('images/products/products-1.jpg');?>" alt="Card image cap">
			</a>
		</div>
		<div class="card-body">
...
<div class="product-item bg-light">
	<div class="card">
		<div class="thumb-content">
			<!-- <div class="price">$200</div> -->
			<a href="single.html">
				<img class="card-img-top img-fluid" src="<?php echo base_url('images/products/products-2.jpg');?>" alt="Card image cap">
			</a>
		</div>
		<div class="card-body">
...
<div class="product-item bg-light">
	<div class="card">
		<div class="thumb-content">
			<!-- <div class="price">$200</div> -->
			<a href="single.html">
				<img class="card-img-top img-fluid" src="<?php echo base_url('images/products/products-3.jpg');?>" alt="Card image cap">
			</a>
		</div>
		<div class="card-body">
		    <h4 class="card-title"><a href="single.html">11inch Macbook Air</a></h4>
